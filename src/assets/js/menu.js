        ...
        return (
          ...
          (n = [
                    ...
                    .then(function () {
                      if (n._horizontal && e._isRoot(r))
                        ...
                        if ((r.classList.remove('open'), i))
                          for (
                            var t = r.querySelectorAll('.menu-item.open'), o = 0, l = t.length;
                            o < l;
                            o++
                          )
            ...
            },
            {
              ...
              value: function (t, n) {
                for (
                  var i = e._findChild(t.parentNode, ['menu-item', 'open']), o = 0, r = i.length;
                  o < r;
                  o++
                )
              ...
              value: function (t, n, i) {
                ...
                if (t) {
                  e._findParent(n, 'menu-sub', !1) &&
                    ((s = !0), (n = this._topParent ? this._topParent.parentNode : n))
                  ...
                  if (
                    ...
                    for (
                      var _ = o.querySelectorAll('.menu-item.open'), v = 0, m = _.length;
                      v < m;
                      v++
                    )
              ...
              value: function (t, n) {
                ...
                for (var r = 0, s = (i = i.slice(0, i.indexOf(o))).length; r < s; r++)
                  if ((i[r].classList.add('open'), this._accordion))
                    for (
                      var l = e._findChild(i[r].parentNode, ['menu-item', 'open']),
                        a = 0,
                        u = l.length;
                      a < u;
                      a++
                      ...
                      if (l[a] !== i[r] && (l[a].classList.remove('open'), n))
                        for (
                          var c = l[a].querySelectorAll('.menu-item.open'), d = 0, h = c.length;
                          d < h;
                          d++
                        )
                  ...
                  : ((n.style.height = ''.concat(
                    ...
                    e._bindAnimationEndEvent(n, function () {
                      if ((n.classList.remove('open'), a(), i))
                        for (
                          var e = n.querySelectorAll('.menu-item.open'), t = 0, l = e.length;
                          t < l;
                          t++
                        )
            ...
            },
            {
              ...
              set: function (e) {
                return (
                  (this._inner.style[this._rtl ? 'marginRight' : 'marginLeft'] = ''.concat(
                    e,
                    'px'
                  )),
                  e
            ...
            },
            {
              ...
              value: function () {
                if (this._el) {
                  this._unbindEvents()
                  for (
                    var t = this._el.querySelectorAll('.menu-item'), n = 0, i = t.length;
                    n < i;
                    n++
                  )
                  ...
                  for (
                    var o = this._el.querySelectorAll('.menu-menu'), r = 0, s = o.length;
                    r < s;
                    r++
                  )
            ...
            },
            {
              ...
              value: function (t, n) {
                ...
                if (
                  ...
                  throw new Error(
                    ''.concat(n ? 'Toggable ' : '', '`.menu-item` element not found.')
                  )
                return i
              }
            },
            {
              ...
              value: function (t, n) {
                ...
                if (
                  (t.classList.contains(o)
                    ? (i = [t])
                    : t.classList.contains('menu-item') && (i = e._findChild(t, [o])),
                  !i.length)
                )

        ...
        <div><!-- ---------------------------------- -->
            ...
            <div class="brand-logo d-flex align-items-center justify-content-between">
                <a href="../dark/index.html" class="text-nowrap logo-img">
                    <img src="/src/assets/images/logo.png" class="dark-logo" alt="Logo-Dark" style="display: none;">
                    <img src="/src/assets/images/logo.png" class="light-logo" alt="Logo-light" style="display: flex;">
                </a>
                            ...
                            <div class="simplebar-content-wrapper" tabindex="0" role="region"
                                ...
                                <div class="simplebar-content" style="padding: 10px;">
                                    <ul id="sidebarnav">
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link active" href="../dark/index2.html"
                                                aria-expanded="false">
                                                <span>
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/app-calendar.html"
                                                aria-expanded="false">
                                                <span>
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/app-kanban.html"
                                                aria-expanded="false">
                                                <span>
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/app-contact.html"
                                                aria-expanded="false">
                                                <span>
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/app-contact2.html"
                                                aria-expanded="false">
                                                <span>
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/app-invoice.html"
                                                aria-expanded="false">
                                                <span>
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/page-user-profile.html"
                                                aria-expanded="false">
                                                <span>
                                        ...
                                        <li class="sidebar-item">
                                            ...
                                            <ul aria-expanded="false" class="collapse first-level">
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="../dark/eco-add-product.html" class="sidebar-link">
                                                        <div
                                                            class="round-16 d-flex align-items-center justify-content-center">
                                                            <i class="ti ti-circle"></i>
                                                        </div>
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="../dark/eco-edit-product.html" class="sidebar-link">
                                                        <div
                                                            class="round-16 d-flex align-items-center justify-content-center">
                                                            <i class="ti ti-circle"></i>
                                                        </div>
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/page-pricing.html"
                                                aria-expanded="false">
                                                <span>
                                                    <i class="ti ti-currency-dollar"></i>
                                                </span>
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/page-account-settings.html"
                                                aria-expanded="false">
                                                <span>
                                                    <i class="ti ti-user-circle"></i>
                                                </span>
                                        ...
                                        <li class="sidebar-item">
                                            ...
                                            <ul aria-expanded="false" class="collapse first-level">
                                                <li class="sidebar-item">
                                                    <a href="../dark/form-bootstrap-validation.html"
                                                        class="sidebar-link">
                                                        <div
                                                            class="round-16 d-flex align-items-center justify-content-center">
                                                            <i class="ti ti-circle"></i>
                                        ...
                                        <li class="sidebar-item">
                                            ...
                                            <ul aria-expanded="false" class="collapse first-level">
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="../dark/form-picker-bootstrap-rangepicker.html"
                                                        class="sidebar-link">
                                                        <div
                                                            class="round-16 d-flex align-items-center justify-content-center">
                                                            <i class="ti ti-circle"></i>
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="../dark/form-picker-bootstrap-datepicker.html"
                                                        class="sidebar-link">
                                                        <div
                                                            class="round-16 d-flex align-items-center justify-content-center">
                                                            <i class="ti ti-circle"></i>
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="../dark/form-picker-material-datepicker.html"
                                                        class="sidebar-link">
                                                        <div
                                                            class="round-16 d-flex align-items-center justify-content-center">
                                                            <i class="ti ti-circle"></i>
                                        ...
                                        <!-- ---------------------------------- -->
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/form-basic.html"
                                                aria-expanded="false">
                                                <span class="d-flex">
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/form-vertical.html"
                                                aria-expanded="false">
                                                <span class="d-flex">
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/form-horizontal.html"
                                                aria-expanded="false">
                                                <span class="d-flex">
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/form-actions.html"
                                                aria-expanded="false">
                                                <span class="d-flex">
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/form-row-separator.html"
                                                aria-expanded="false">
                                                <span class="d-flex">
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/form-bordered.html"
                                                aria-expanded="false">
                                                <span class="d-flex">
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/form-detail.html"
                                                aria-expanded="false">
                                                <span class="d-flex">
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/form-striped-row.html"
                                                aria-expanded="false">
                                                <span class="d-flex">
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/form-floating-input.html"
                                                aria-expanded="false">
                                                <span class="d-flex">
                                        ...
                                        <!-- ---------------------------------- -->
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/form-wizard.html"
                                                aria-expanded="false">
                                                <span class="d-flex">
                                        ...
                                        <!-- ---------------------------------- -->
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../dark/form-repeater.html"
                                                aria-expanded="false">
                                                <span class="d-flex">
                                        ...
                                        <li class="sidebar-item">
                                            ...
                                            <ul aria-expanded="false" class="collapse first-level">
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="../dark/table-datatable-advanced.html"
                                                        class="sidebar-link">
                                                        <div
                                                            class="round-16 d-flex align-items-center justify-content-center">
                                                            <i class="ti ti-circle"></i>
                                        ...
                                        <!-- ---------------------------------- -->
                                        <li class="sidebar-item">
                                            <a class="sidebar-link sidebar-link" href="../dark/icon-solar.html"
                                                aria-expanded="false">
                                                <span class="rounded-3">
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link sidebar-link"
                                                href="../dark/authentication-error.html" aria-expanded="false">
                                                <span class="rounded-3">
                                                    <i class="ti ti-alert-circle"></i>
                                                </span>
                                        ...
                                        <li class="sidebar-item">
                                            ...
                                            <ul aria-expanded="false" class="collapse first-level">
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="../dark/authentication-register2.html"
                                                        class="sidebar-link">
                                                        <div
                                                            class="round-16 d-flex align-items-center justify-content-center">
                                                            <i class="ti ti-circle"></i>
                                        ...
                                        <li class="sidebar-item">
                                            ...
                                            <ul aria-expanded="false" class="collapse first-level">
                                                <li class="sidebar-item">
                                                    <a href="../dark/authentication-forgot-password.html"
                                                        class="sidebar-link">
                                                        <div
                                                            class="round-16 d-flex align-items-center justify-content-center">
                                                            <i class="ti ti-circle"></i>
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="../dark/authentication-forgot-password2.html"
                                                        class="sidebar-link">
                                                        <div
                                                            class="round-16 d-flex align-items-center justify-content-center">
                                                            <i class="ti ti-circle"></i>
                                        ...
                                        <li class="sidebar-item">
                                            ...
                                            <ul aria-expanded="false" class="collapse first-level">
                                                <li class="sidebar-item">
                                                    <a href="../dark/authentication-two-steps.html"
                                                        class="sidebar-link">
                                                        <div
                                                            class="round-16 d-flex align-items-center justify-content-center">
                                                            <i class="ti ti-circle"></i>
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="../dark/authentication-two-steps2.html"
                                                        class="sidebar-link">
                                                        <div
                                                            class="round-16 d-flex align-items-center justify-content-center">
                                                            <i class="ti ti-circle"></i>
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link link-disabled" href="#disabled"
                                                aria-expanded="false">
                                                <span class="d-flex">
                                                    <i class="ti ti-ban"></i>
                                                </span>
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link justify-content-between" href="#chip"
                                                aria-expanded="false">

                        ...
                        <li class="sidebar-item">
                          ...
                          <ul aria-expanded="false" class="collapse first-level my-3">
                            ...
                            <li class="sidebar-item py-2">
                              ...
                              >
                                ...
                                <div>
                                  ...
                                  <span class="fs-2 d-block text-muted"
                            ...
                            <ul class="px-8 mt-7 mb-4">
                              ...
                              <li class="sidebar-item py-2">
                                <a class="fw-semibold text-dark" href="../dark/page-pricing.html"
                                  >Pricing Page</a
                                >
                              </li>
                              <li class="sidebar-item py-2">
                              ...
                              <li class="sidebar-item py-2">
                                <a class="fw-semibold text-dark" href="../dark/app-notes.html"
                                  >Notes App</a
                                >
                              </li>
                              <li class="sidebar-item py-2">
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <div class="profile-dropdown position-relative">
                    ...
                    <div class="d-grid py-4 px-7 pt-8">
                      <a href="" @click.prevent="logOut" class="btn btn-outline-primary">Log Out</a>
                    </div>
                  </div>
                </div>
              </li>

                                ...
                                <a class="nav-link pe-0" href="javascript:void(0)" id="drop1" aria-expanded="false">
                                    <div class="d-flex align-items-center">
                                        <div class="user-profile-img">
                                            <img src="/user-1.jpg" class="rounded-circle" width="35" height="35"
                                                alt="modernize-img">
                                        </div>
                                    </div>
                                </a>
                                <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                                    ...
                                    <div class="profile-dropdown position-relative" data-simplebar="init">
                                        ...
                                        <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                                            <img src="/user-1.jpg" class="rounded-circle" width="80" height="80"
                                                alt="modernize-img">
                                            <div class="ms-3">
                                    ...
                                    <div class="simplebar-content-wrapper" tabindex="0" role="region"
                                        ...
                                        <div class="simplebar-content" style="padding: 16px;">
                                            <ul id="sidebarnav">
                                                        ...
                                                        <li class="sidebar-item py-2">
                                                            <a href="../dark/app-email.html"
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <span class="fs-2 d-block text-muted">Get new
                                                                        emails</span>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li class="sidebar-item py-2">
                                                            <a href="../dark/app-contact2.html"
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <span class="fs-2 d-block text-muted">Add new
                                                                        contact</span>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="sidebar-item py-2">
                                                            <a href="../dark/app-notes.html"
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <span class="fs-2 d-block text-muted">To-do and
                                                                        Daily tasks</span>
                                                                </div>
                                                            </a>
                                                        </li>
                                                ...
                                                <li class="sidebar-item">
                                                    <a class="sidebar-link" href="../dark/app-chat.html"
                                                        aria-expanded="false">
                                                        <span>
                ...
                <ul class="navbar-nav align-items-center">
                    ...
                    <li class="nav-item d-none d-xl-block">
                        <a href="../dark/index.html" class="text-nowrap nav-link">
                            <img src="/src/assets/images/logo.png" class="dark-logo" width="120" alt="modernize-img">
                            <img src="/src/assets/images/logo.png" class="light-logo" width="120" alt="modernize-img"
                                style="display: none;">
                        </a>
                    </li>
                </ul>

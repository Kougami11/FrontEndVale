        ...
        <div class="row">
          <div class="col-xl-7 col-xxl-8">
            <a href="../dark/index.html" class="text-nowrap logo-img d-block px-4 py-9 w-100">
              <img src="../assets/images/logos/dark-logo.svg" class="dark-logo" alt="Logo-Dark" style="display: none;">
              ...
              <div class="auth-max-width col-sm-8 col-md-6 col-xl-7 px-4">
                ...
                <form>
                  ...
                  <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <a class="text-primary fw-medium fs-3" href="../dark/authentication-forgot-password.html">Forgot Password ?</a>
                  </div>
